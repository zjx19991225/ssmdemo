            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                ...
                <div class="toolbar-btn-action">
                  <a class="btn btn-primary m-r-5" href="${pageContext.request.contextPath}/pages/pages_book_add.jsp"><i class="mdi mdi-plus"></i> 新增</a>
              ...
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <c:forEach var="book" items="${books.list}">
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/book/findBookById?id=${book.bookId}" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                            <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/book/delBook?id=${book.bookId}" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                          </div>
                        </td>
                ...
                <ul class="pagination">
                  ...
                  <li><a href="${pageContext.request.contextPath}/book/findAllBook?id=1&size=5">首页</a></li>
                  <li><a href="${pageContext.request.contextPath}/book/findAllBook?id=${books.pageNum-1}&size=5">上一页</a></li>
                  <c:forEach var="bookpages" begin="1" end="${books.pages}">
                    <li><a href="${pageContext.request.contextPath}/book/findAllBook?id=${bookpages}&size=5">${bookpages}</a></li>
                  </c:forEach>
                  <li><a href="${pageContext.request.contextPath}/book/findAllBook?id=${books.pageNum+1}&size=5">下一页</a></li>
                  <li><a href="${pageContext.request.contextPath}/book/findAllBook?id=${books.pages}&size=5">尾页</a></li>
