<%@ page contentType="text/html;charset=UTF-8" language="java" %><html lang="zh">
<head>
<meta charset="utf-8">
              ...
              <div class="card-body">
                ...
                <form method="post" action="#!" class="site-form">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="account" id="account" value="${user.account}" disabled="disabled" />
                  </div>
                  <div class="form-group">
                    <label for="username">用户名</label>
                    <input type="text" class="form-control" name="username" id="username" placeholder="输入您的昵称" value="${user.user}" >
                  </div>
...
$(function () {
    $(".submit").on("click",function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/user/updInfomation",
            type:"post",
            dataType:"json",
            data:{
                username:username
