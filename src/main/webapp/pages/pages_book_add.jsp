      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 新增页面 </span>
          </div>
              ...
              <div class="card-body">
                ...
                <form action="#!" method="post" class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="bookname" name="bookname" value="" placeholder="请输入图书" />
                  </div>
                  <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="price" name="price" value="" placeholder="请输入价格" />
                  </div>
                  <div class="form-group col-md-12">
                    <label for="author">作者</label>
                    <input type="text" class="form-control" id="author" name="author" value="" placeholder="请输入作者" />
                  </div>
      ...
      $("#submit").on("click",function () {
          ...
          $.ajax({
              ...
              success:function (data) {
                      alert("添加成功");
                      window.location.href="${pageContext.request.contextPath}/book/findAllBook";
