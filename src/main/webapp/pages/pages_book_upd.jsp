              ...
              <div class="card-body">
                ...
                <form action="#!" method="post" class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="bookName" name="bookName" value="${book.bookName}" placeholder="请输入图书名称" />
                  </div>
                  <div class="form-group col-md-12">
                    <label for="number">图书数量</label>
                    <input type="text" class="form-control" id="number" name="number" value="${book.number}" placeholder="请输入图书数量" />
                  </div>
                  <div class="form-group col-md-12">
...
<script>
  $(function () {
      $("#submit").on("click",function () {
          ...
          $.ajax({
              url:"${pageContext.request.contextPath}/book/updBook",
              type:"post",
              dataType:"json",
              data:{
                  bookName:bookName,
